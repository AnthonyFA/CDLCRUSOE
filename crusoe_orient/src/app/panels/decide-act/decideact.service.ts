...
/*ELiminados dd*/
  ...
  public getPaos(): Observable<PaoResponse> {
    return this.http.get<PaoResponse>(environment.baseUrl + 'act/paos');
  }
  ...
  public getMissions(): Observable<Mission[]> {
    return this.http.get<Mission[]>(environment.baseUrl + 'missions');
  }
  /*Antes estaba     return this.http.get<Mission[]>(environment.baseUrl + 'rest/' + 'missions');*/ 
  /**
   * Get mission configurations
   */
  public getMissionConfigurations(mission: string): Observable<Configuration[]> {
    return this.http.get<Configuration[]>(environment.baseUrl + 'mission/' + mission + '/configurations');
  }
  ...
  public getMissionConfiguration(mission: string, id: number): Observable<Configuration> {
    return this.http.get<Configuration[]>(environment.baseUrl  + 'mission/' + mission + '/configurations').pipe(
      map((configs) => {
  ...
  public getConfigurationHosts(mission: string, id: number): Observable<Host[]> {
    return this.http.get<Host[]>(
      environment.baseUrl +  'mission/' + mission + '/configuration/' + id + '/hosts'
    );
  }

  /** Get PAO maximum capacity */
  public getPaoMaxCapacity(pao: string): Observable<{ maxCapacity: number }> {
    return this.http.get<{ maxCapacity: number }>(environment.baseUrl  + 'act/' + pao + '/maxCapacity');
  }

  /** Get PAO used capacity */
  public getPaoUsedCapacity(pao: string): Observable<{ usedCapacity: number }> {
    return this.http.get<{ usedCapacity: number }>(environment.baseUrl  + 'act/' + pao + '/usedCapacity');
  }
  ...
  public getPaoStatus(pao: string): Observable<PaoStatus> {
    return this.http.get<PaoStatus>(environment.baseUrl  + 'act/' + pao + '/status');
  }
  ...
  public getMission(missionName: string): Observable<Mission> {
    return this.http.get<Mission>(environment.baseUrl  + 'missions/' + missionName);
  }
